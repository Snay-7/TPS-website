        ...
        <div className="max-w-4xl mx-auto mt-12">
          {!showSave && !saved && (
            <div className="bg-gradient-to-br from-brand-yellow to-yellow-400 rounded-3xl p-10 text-center shadow-2xl border-4 border-brand-yellow">
              ...
              <p className="text-navy/80 text-lg mb-6 max-w-2xl mx-auto">Get a copy emailed to you. Receive matched off-market deals based on your numbers.</p>
            ...
            <div className="bg-white rounded-3xl shadow-2xl border-2 border-brand-yellow p-8 md:p-10">
              <div className="flex items-start justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Your details (kept private). We&apos;ll email you a copy and match off-market deals.</p>
                </div>
          ...
          {saved && (
            <div className="bg-white rounded-3xl shadow-2xl p-10 text-center border-2 border-brand-green">
              ...
              <p className="text-gray-600 mb-6 max-w-md mx-auto">We&apos;ve saved your calculation. We&apos;ll be in touch when matching deals come up.</p>
